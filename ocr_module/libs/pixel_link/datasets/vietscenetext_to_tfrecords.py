...
if __name__ == "__main__":
    root_dir = util.io.get_absolute_path('/workingspace/WorkingSpace/SceneText/thangdd/data/viet_scene_text/')
    output_dir = util.io.get_absolute_path('/workingspace/WorkingSpace/SceneText/thangdd/text_detection/pixel_link/datasets/vietscenetext/')
    ...
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'vietscenetext_train.tfrecord'), data_path = training_data_dir, gt_path = training_gt_dir)

    #test_data_dir = util.io.join_path(root_dir, 'test/images')
    #test_gt_dir = util.io.join_path(root_dir,'test/annotations')
    #cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'vietscenetext_test.tfrecord'), data_path = test_data_dir, gt_path = test_gt_dir)
