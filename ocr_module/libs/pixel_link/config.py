...
# model_type = pixel_link_symbol.MODEL_TYPE_res50_v2
# feat_layers = ['conv1', 'pool1', 'block1', 'block2', 'block4']
# strides = [2]

# model_type = pixel_link_symbol.MODEL_TYPE_my_res50_v2
# feat_layers = ['pool1', 'block1', 'block2', 'block3', 'block4']
# strides = [2]
...
# model_type = pixel_link_symbol.MODEL_TYPE_vgg16_1
# feat_layers = ['conv2_2', 'conv3_3', 'conv4_3', 'conv5_3', 'fc7']
# strides = [2]
